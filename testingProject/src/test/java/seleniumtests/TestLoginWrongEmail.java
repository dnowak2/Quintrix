...
public class TestLoginWrongEmail {
	...
	public void signIn() {
		...
		emailTextField.sendKeys("dn9overflow444@gmail.com");
		passwordTextField.sendKeys("R1uby2019");
		signInButton.click();
		
		WebElement emailError = driver.findElement(By.id("aria-join_neu_email_field-error"));
		Assert.assertTrue(emailError.isEnabled());
	}
